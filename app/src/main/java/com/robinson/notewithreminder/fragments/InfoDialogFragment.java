...
public class InfoDialogFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
     ...
     //   String time  = CommonParameters.noteTime;

        if (getArguments() != null) {
            time_get = getArguments().getString(CommonParameters.noteTime);
            date_get = getArguments().getString(CommonParameters.noteDate);
        }
      ...
      /*  if (getArguments() != null && !TextUtils.isEmpty(getArguments().getString("time_value")))
        ...
        if (TextUtils.isEmpty(time_get) || time_get.equalsIgnoreCase("ignore")) {
        ...
        if (TextUtils.isEmpty(date_get) || date_get.equalsIgnoreCase("ignore")) {
        ...
        back_rem.setOnClickListener(v -> {
//                Toast.makeText(getContext(),"back_rem",Toast.LENGTH_SHORT).show();
            dismiss();
        });

        time_pick.setOnClickListener(v -> {
//                Toast.makeText(getContext(),"time_pick",Toast.LENGTH_SHORT).show();
            ...
            TimeDialogFragment poptime = new TimeDialogFragment();
...
//                Toast.makeText(getContext(),"date_pic",Toast.LENGTH_SHORT).show();
            ...
            DateDialogFragment popdate = new DateDialogFragment();
        ...
        delete_rem.setOnClickListener(v -> {
            Toast.makeText(getContext(), "Reminder Removed!", Toast.LENGTH_SHORT).show();
            NoteUpdateActivity m3a1 = (NoteUpdateActivity) getActivity();
            m3a1.deleteRem();
            dismiss();
        });


        save_rem.setOnClickListener(v -> {
            Toast.makeText(getContext(), "Reminder Added!", Toast.LENGTH_SHORT).show();
            NoteUpdateActivity m3a = (NoteUpdateActivity) getActivity();
